...
.countdown{margin:0 16px 14px;background:linear-gradient(145deg,#f9fcff 0%,#edf6ff 72%,#fffdf8 100%);border:1px solid #fff;border-radius:28px;padding:18px 14px 18px;box-shadow:0 9px 28px #397fb316;position:relative;overflow:hidden;min-height:205px}.countdownHead{display:flex;align-items:center;justify-content:center;gap:10px;position:relative;z-index:4;padding:0 72px}.countdownCalendar{font-size:25px;line-height:1}.countdownTitleWrap{text-align:left}.countdownTitle{font-size:17px;line-height:1.12;font-weight:850;color:#183a63;white-space:nowrap}.countdownSub{font-size:10px;color:#71879b;margin-top:4px;white-space:nowrap}.countdownDate{position:absolute;right:18px;top:14px;font-size:13px;font-weight:700;color:#b97813;transform:rotate(-7deg);line-height:1.15;text-align:center;font-family:"Segoe Print","Comic Sans MS",cursive;z-index:5}.countdownPlane{position:absolute;right:58px;top:58px;width:30px;height:20px;z-index:4;transform:rotate(-12deg)}.countdownPlane:before{content:'';position:absolute;left:0;top:6px;border-left:30px solid #d7a02b;border-top:8px solid transparent;border-bottom:5px solid transparent}.countdownPlane:after{content:'';position:absolute;left:7px;top:10px;border-left:17px solid #f0c34c;border-top:4px solid transparent;border-bottom:3px solid transparent}.countdownTrail{position:absolute;right:22px;top:70px;width:58px;height:34px;border-right:2px dashed #c99838;border-bottom:2px dashed #c99838;border-radius:0 0 38px 0;transform:rotate(-8deg);z-index:2}.countdownCapBig{position:absolute;left:12px;bottom:22px;font-size:46px;transform:rotate(-7deg);filter:drop-shadow(0 5px 6px #1c375426);z-index:4}.countdownGrid{display:flex;justify-content:center;align-items:center;margin:22px 54px 0;position:relative;z-index:3}.countdownBox{width:170px;background:linear-gradient(180deg,#fff,#f5faff);border:1px solid #fff;border-radius:24px;padding:15px 12px 13px;text-align:center;box-shadow:0 7px 20px #3b7dac12}.countdownBox b{display:block;font-size:46px;line-height:1;color:#1676d2;font-weight:850;letter-spacing:-1px}.countdownBox small{display:block;margin-top:8px;font-size:10px;color:#667b90;text-transform:uppercase;font-weight:700}.countdownWish{position:absolute;right:18px;bottom:16px;font-family:"Segoe Print","Comic Sans MS",cursive;font-size:12px;font-weight:800;color:#174f91;transform:rotate(-5deg);z-index:5;padding:4px 9px;line-height:1.05;background:linear-gradient(165deg,transparent 10%,#dcecff9c 11% 88%,transparent 89%)}.countdownDots{position:absolute;left:50%;bottom:12px;transform:translateX(-50%);display:flex;gap:6px;z-index:5}.countdownDots i{width:6px;height:6px;border-radius:50%;background:#c9dcf2}.countdownDots i:first-child{background:#1780d8}.countdownConfetti span{position:absolute;z-index:4;color:#e3b23c;font-size:11px}.countdownConfetti span:nth-child(1){left:18px;top:18px}.countdownConfetti span:nth-child(2){right:24px;bottom:52px}.classStat b{white-space:nowrap}@media(max-width:390px){.countdown{min-height:198px;padding-left:10px;padding-right:10px}.countdownHead{padding:0 58px}.countdownTitle{font-size:15px}.countdownSub{font-size:9px}.countdownDate{font-size:11px;right:10px}.countdownPlane{right:50px;transform:scale(.88) rotate(-12deg)}.countdownCapBig{font-size:42px;left:8px;bottom:24px}.countdownGrid{margin:21px 48px 0}.countdownBox{width:155px;padding:14px 10px 12px}.countdownBox b{font-size:42px}.countdownWish{font-size:11px;right:10px}}
</style></head>`);

...
.countdown{margin:0 16px 14px;background:linear-gradient(145deg,#f9fcff 0%,#edf6ff 72%,#fffdf8 100%);border:1px solid #fff;border-radius:28px;padding:18px 14px 18px;box-shadow:0 9px 28px #397fb316;position:relative;overflow:hidden;min-height:232px}.countdownHead{display:flex;align-items:center;justify-content:center;gap:10px;position:relative;z-index:4;padding:0 72px}.countdownCalendar{font-size:25px;line-height:1}.countdownTitleWrap{text-align:left}.countdownTitle{font-size:17px;line-height:1.12;font-weight:850;color:#183a63;white-space:nowrap}.countdownSub{font-size:10px;color:#71879b;margin-top:4px;white-space:nowrap}.countdownDate{position:absolute;right:18px;top:14px;font-size:13px;font-weight:700;color:#b97813;transform:rotate(-7deg);line-height:1.15;text-align:center;font-family:"Segoe Print","Comic Sans MS",cursive;z-index:5}.countdownPlane{position:absolute;right:64px;top:50px;width:30px;height:20px;z-index:4;transform:rotate(-12deg)}.countdownPlane:before{content:'';position:absolute;left:0;top:6px;border-left:30px solid #d7a02b;border-top:8px solid transparent;border-bottom:5px solid transparent}.countdownPlane:after{content:'';position:absolute;left:7px;top:10px;border-left:17px solid #f0c34c;border-top:4px solid transparent;border-bottom:3px solid transparent}.countdownTrail{position:absolute;right:22px;top:62px;width:64px;height:42px;border-right:2px dashed #c99838;border-bottom:2px dashed #c99838;border-radius:0 0 38px 0;transform:rotate(-8deg);z-index:2}.countdownCapBig{position:absolute;left:-2px;bottom:45px;font-size:49px;transform:rotate(-7deg);filter:drop-shadow(0 5px 6px #1c375426);z-index:4}.countdownGrid{display:flex;justify-content:center;align-items:center;margin:24px 48px 0;position:relative;z-index:3}.countdownBox{width:185px;background:linear-gradient(180deg,#fff,#f5faff);border:1px solid #fff;border-radius:24px;padding:16px 12px 14px;text-align:center;box-shadow:0 7px 20px #3b7dac12}.countdownBox b{display:block;font-size:46px;line-height:1;color:#1676d2;font-weight:850;letter-spacing:-1px}.countdownBox small{display:block;margin-top:8px;font-size:10px;color:#667b90;text-transform:uppercase;font-weight:700}.countdownRibbon{position:absolute;left:-20px;bottom:-5px;width:210px;height:70px;z-index:2;transform:rotate(2deg)}.countdownRibbon:before{content:'';position:absolute;left:-28px;top:24px;width:160px;height:34px;border-radius:54% 46% 55% 45%;background:linear-gradient(180deg,#f9dc77 0%,#d89b1c 48%,#efc650 100%);transform:rotate(10deg) skewX(-8deg);box-shadow:0 6px 10px #a66f1422}.countdownRibbon:after{content:'';position:absolute;left:78px;top:7px;width:154px;height:36px;border-radius:46% 54% 45% 55%;background:linear-gradient(180deg,#c88913 0%,#f6d66d 45%,#d89b1c 100%);transform:rotate(-18deg) skewX(7deg);box-shadow:0 6px 10px #a66f1422}.countdownWish{position:absolute;right:18px;bottom:8px;font-family:"Segoe Print","Comic Sans MS",cursive;font-size:12px;font-weight:800;color:#174f91;transform:rotate(-5deg);z-index:5;padding:4px 9px;line-height:1.05;background:linear-gradient(165deg,transparent 10%,#dcecff9c 11% 88%,transparent 89%)}.countdownDots{position:absolute;left:50%;bottom:12px;transform:translateX(-50%);display:flex;gap:6px;z-index:5}.countdownDots i{width:6px;height:6px;border-radius:50%;background:#c9dcf2}.countdownDots i:first-child{background:#1780d8}.countdownConfetti span{position:absolute;z-index:4;color:#e3b23c;font-size:11px}.countdownConfetti span:nth-child(1){left:18px;top:18px}.countdownConfetti span:nth-child(2){right:24px;bottom:52px}.classStat b{white-space:nowrap}@media(max-width:390px){.countdown{min-height:226px;padding-left:10px;padding-right:10px}.countdownHead{padding:0 58px}.countdownTitle{font-size:15px}.countdownSub{font-size:9px}.countdownDate{font-size:11px;right:10px}.countdownPlane{right:54px;transform:scale(.88) rotate(-12deg)}.countdownCapBig{font-size:44px;left:-5px;bottom:48px}.countdownGrid{margin:23px 42px 0}.countdownBox{width:165px;padding:15px 10px 13px}.countdownBox b{font-size:42px}.countdownWish{font-size:11px}.countdownRibbon{width:185px;left:-24px}}
</style></head>`);

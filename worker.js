...
.countdown{margin:0 16px 14px;background:linear-gradient(145deg,#f8fcff 0%,#eaf5ff 68%,#fffdf7 100%);border:1px solid #fff;border-radius:28px;padding:20px 14px 18px;box-shadow:0 10px 30px #397fb319;position:relative;overflow:hidden;min-height:286px}.countdownHead{position:relative;z-index:4;text-align:left;padding-left:98px;padding-right:92px}.countdownTitle{font-size:19px;line-height:1.12;font-weight:850;color:#183a63;white-space:nowrap}.countdownSub{font-size:11px;color:#71879b;margin-top:5px;white-space:nowrap}.countdownCalendar{position:absolute;left:70px;top:18px;font-size:27px;z-index:4}.countdownDate{position:absolute;right:20px;top:18px;font-size:15px;font-weight:700;color:#b97813;transform:rotate(-8deg);line-height:1.18;text-align:center;font-family:"Segoe Print","Comic Sans MS",cursive;z-index:5}.countdownPlane{position:absolute;right:74px;top:50px;font-size:31px;transform:rotate(-13deg);z-index:4}.countdownTrail{position:absolute;right:22px;top:77px;width:78px;height:54px;border-right:2px dashed #c99838;border-bottom:2px dashed #c99838;border-radius:0 0 46px 0;transform:rotate(-10deg);z-index:2}.countdownCapBig{position:absolute;left:-14px;top:86px;font-size:91px;transform:rotate(-8deg);filter:drop-shadow(0 8px 8px #1c375433);z-index:5}.countdownGrid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin:30px 0 0 90px;position:relative;z-index:3}.countdownBox{background:linear-gradient(180deg,#fff,#f5faff);border:1px solid #fff;border-radius:22px;padding:17px 3px 14px;text-align:center;box-shadow:0 7px 20px #3b7dac12;min-width:0}.countdownBox b{display:block;font-size:31px;line-height:1;color:#1676d2;font-weight:850;letter-spacing:-1px}.countdownBox small{display:block;margin-top:9px;font-size:9px;color:#667b90;text-transform:uppercase;font-weight:700}.countdownRibbon{position:absolute;left:-34px;bottom:10px;width:170px;height:68px;border-radius:50%;border-top:15px solid #d5a329;transform:rotate(16deg);z-index:2}.countdownRibbon:after{content:'';position:absolute;left:55px;top:-43px;width:125px;height:54px;border-radius:50%;border-bottom:15px solid #efc54c;transform:rotate(-27deg)}.countdownWish{position:absolute;right:17px;bottom:11px;font-family:"Segoe Print","Comic Sans MS",cursive;font-size:15px;font-weight:800;color:#174f91;transform:rotate(-8deg);z-index:5;background:linear-gradient(165deg,transparent 12%,#d9eaff 13% 86%,transparent 87%);padding:5px 10px;line-height:1.05}.countdownDots{position:absolute;left:50%;bottom:17px;transform:translateX(-50%);display:flex;gap:7px;z-index:5}.countdownDots i{width:7px;height:7px;border-radius:50%;background:#c9dcf2}.countdownDots i:first-child{background:#1780d8}.countdownConfetti span{position:absolute;z-index:4;color:#e3b23c;font-size:16px}.countdownConfetti span:nth-child(1){left:18px;top:16px}.countdownConfetti span:nth-child(2){left:55px;top:57px;transform:rotate(22deg)}.countdownConfetti span:nth-child(3){left:22px;bottom:54px}.countdownConfetti span:nth-child(4){right:20px;bottom:66px}.countdownConfetti span:nth-child(5){left:125px;bottom:25px}.classStat b{white-space:nowrap}@media(max-width:390px){.countdown{min-height:274px;padding-left:10px;padding-right:10px}.countdownHead{padding-left:76px;padding-right:75px}.countdownCalendar{left:53px}.countdownTitle{font-size:17px}.countdownSub{font-size:10px}.countdownDate{font-size:13px;right:12px}.countdownPlane{right:59px;font-size:27px}.countdownCapBig{font-size:78px;left:-15px;top:94px}.countdownGrid{margin-left:66px;gap:6px}.countdownBox{padding:15px 1px 13px;border-radius:19px}.countdownBox b{font-size:27px}.countdownWish{font-size:13px}.countdownRibbon{width:145px}}
</style></head>`);

...
.countdown{margin:0 16px 14px;background:linear-gradient(145deg,#f8fcff 0%,#eaf5ff 68%,#fffdf7 100%);border:1px solid #fff;border-radius:28px;padding:20px 14px 18px;box-shadow:0 10px 30px #397fb319;position:relative;overflow:hidden;min-height:286px}.countdownHead{position:relative;z-index:4;text-align:left;padding-left:70px;padding-right:92px}.countdownTitle{font-size:18px;line-height:1.12;font-weight:850;color:#183a63;white-space:nowrap}.countdownSub{font-size:11px;color:#71879b;margin-top:5px;white-space:nowrap}.countdownCalendar{position:absolute;left:28px;top:17px;font-size:27px;z-index:4}.countdownDate{position:absolute;right:20px;top:16px;font-size:15px;font-weight:700;color:#b97813;transform:rotate(-8deg);line-height:1.18;text-align:center;font-family:"Segoe Print","Comic Sans MS",cursive;z-index:5}.countdownPlane{position:absolute;right:63px;top:57px;font-size:30px;line-height:1;transform:rotate(-12deg);z-index:4;color:#d69b23}.countdownTrail{position:absolute;right:18px;top:74px;width:78px;height:56px;border-right:2px dashed #c99838;border-bottom:2px dashed #c99838;border-radius:0 0 46px 0;transform:rotate(-10deg);z-index:2}.countdownCapBig{position:absolute;left:-22px;top:114px;font-size:80px;transform:rotate(-8deg);filter:drop-shadow(0 8px 8px #1c375433);z-index:5}.countdownGrid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin:30px 0 0 74px;position:relative;z-index:3}.countdownBox{background:linear-gradient(180deg,#fff,#f5faff);border:1px solid #fff;border-radius:22px;padding:17px 3px 14px;text-align:center;box-shadow:0 7px 20px #3b7dac12;min-width:0}.countdownBox b{display:block;font-size:31px;line-height:1;color:#1676d2;font-weight:850;letter-spacing:-1px}.countdownBox small{display:block;margin-top:9px;font-size:9px;color:#667b90;text-transform:uppercase;font-weight:700}.countdownRibbon{position:absolute;left:-10px;bottom:-2px;width:185px;height:72px;z-index:2;transform:rotate(4deg)}.countdownRibbon:before{content:'';position:absolute;left:-22px;top:20px;width:138px;height:30px;border-radius:55% 45% 55% 45%;background:linear-gradient(180deg,#f8d66b 0%,#d79b1d 48%,#f2c94f 100%);transform:rotate(10deg);box-shadow:0 5px 8px #b5791724}.countdownRibbon:after{content:'';position:absolute;left:70px;top:5px;width:132px;height:32px;border-radius:45% 55% 45% 55%;background:linear-gradient(180deg,#c88913 0%,#f4cc55 48%,#d69b20 100%);transform:rotate(-17deg);box-shadow:0 5px 8px #b5791724}.countdownWish{position:absolute;right:17px;bottom:10px;font-family:"Segoe Print","Comic Sans MS",cursive;font-size:15px;font-weight:800;color:#174f91;transform:rotate(-7deg);z-index:5;padding:6px 12px;line-height:1.05;background:linear-gradient(165deg,transparent 8%,#d9eaffb8 9% 88%,transparent 89%);border-radius:42% 15% 38% 18%}.countdownDots{position:absolute;left:50%;bottom:17px;transform:translateX(-50%);display:flex;gap:7px;z-index:5}.countdownDots i{width:7px;height:7px;border-radius:50%;background:#c9dcf2}.countdownDots i:first-child{background:#1780d8}.countdownConfetti span{position:absolute;z-index:4;color:#e3b23c;font-size:16px}.countdownConfetti span:nth-child(1){left:18px;top:16px}.countdownConfetti span:nth-child(2){left:55px;top:57px;transform:rotate(22deg)}.countdownConfetti span:nth-child(3){left:22px;bottom:54px}.countdownConfetti span:nth-child(4){right:20px;bottom:66px}.countdownConfetti span:nth-child(5){left:125px;bottom:25px}.classStat b{white-space:nowrap}@media(max-width:390px){.countdown{min-height:274px;padding-left:10px;padding-right:10px}.countdownHead{padding-left:62px;padding-right:76px}.countdownCalendar{left:22px}.countdownTitle{font-size:16px}.countdownSub{font-size:10px}.countdownDate{font-size:13px;right:12px}.countdownPlane{right:53px;font-size:26px}.countdownCapBig{font-size:70px;left:-20px;top:120px}.countdownGrid{margin-left:58px;gap:6px}.countdownBox{padding:15px 1px 13px;border-radius:19px}.countdownBox b{font-size:27px}.countdownWish{font-size:13px}.countdownRibbon{width:155px;left:-13px}}
</style></head>`);

...
.countdown{margin:0 16px 14px;background:linear-gradient(145deg,#f8fcff 0%,#e9f5ff 58%,#fffaf1 100%);border:1px solid #ffffffcc;border-radius:26px;padding:17px 14px 16px;box-shadow:0 8px 26px #397fb316;position:relative;overflow:hidden}.countdown:before,.countdown:after{content:'✦';position:absolute;color:#e8b84a;opacity:.9;font-size:17px}.countdown:before{left:14px;top:14px;transform:rotate(-18deg)}.countdown:after{right:16px;bottom:16px;transform:rotate(18deg)}.countdownHead{display:flex;align-items:center;justify-content:center;gap:9px;padding:0 16px}.countdownCap{width:38px;height:38px;border-radius:12px;background:#e7f2ff;display:grid;place-items:center;font-size:22px;box-shadow:inset 0 0 0 1px #ffffffaa}.countdownTitleWrap{text-align:left}.countdownTitle{font-size:18px;line-height:1.15;font-weight:800;color:#183a63}.countdownSub{font-size:11px;color:#70879c;margin-top:3px}.countdownDate{position:absolute;right:17px;top:15px;font-size:11px;font-weight:800;color:#b47b19;transform:rotate(-5deg);line-height:1.15;text-align:center}.countdownGrid{display:grid;grid-template-columns:1.25fr 1fr 1fr 1fr;gap:8px;margin:16px 0 8px}.countdownBox{background:#ffffffc9;border:1px solid #ffffff;border-radius:19px;padding:12px 4px 10px;text-align:center;box-shadow:0 5px 16px #3b7dac10}.countdownBox:first-child{background:linear-gradient(180deg,#fdfefe,#eaf4ff)}.countdownBox b{display:block;font-size:29px;line-height:1;color:#1676d2;font-weight:800;letter-spacing:-1px}.countdownBox:first-child b{font-size:34px}.countdownBox small{display:block;margin-top:7px;font-size:9px;color:#6f8293;text-transform:uppercase;font-weight:700}.countdownFooter{display:flex;align-items:center;justify-content:center;gap:7px;font-size:11px;color:#6d8296;font-weight:700}.countdownFooter span{color:#ba8529}.classStat b{white-space:nowrap}@media(max-width:390px){.countdownDate{display:none}.countdownTitle{font-size:17px}.countdownGrid{gap:6px}.countdownBox b{font-size:25px}.countdownBox:first-child b{font-size:30px}}
</style></head>`);
        ...
        html = html.replace('</div><div class="grid"><button class="card"', `</div><div class="countdown" id="graduationCountdown"><div class="countdownHead"><div class="countdownCap">🎓</div><div class="countdownTitleWrap"><div class="countdownTitle">До выпускного осталось</div><div class="countdownSub">Большие мечты начинаются здесь</div></div></div><div class="countdownDate">26 июня<br>2027</div><div class="countdownGrid"><div class="countdownBox"><b id="cdDays">0</b><small>дней</small></div><div class="countdownBox"><b id="cdHours">00</b><small>часов</small></div><div class="countdownBox"><b id="cdMinutes">00</b><small>минут</small></div><div class="countdownBox"><b id="cdSeconds">00</b><small>секунд</small></div></div><div class="countdownFooter">📅 <span>26 июня 2027</span> · Выпускной 2027</div></div><div class="grid"><button class="card"`);
